/*
  # Initial Schema Setup for One World Community App
  ...
  1. New Tables
    ...
    - `topics`
      - Available topics/categories for content
      - Used for organizing articles and events
    
    - `user_topics`
      - User topic preferences/subscriptions
      - Links users to their chosen topics
    ...
    - `user_feeds`
      ...
      - Links users to their subscribed feeds
    
    - `articles`
      - Cached articles from RSS feeds
      - Stores processed feed content
    
    - `events`
      - Community events
      - Stores event details and location info
