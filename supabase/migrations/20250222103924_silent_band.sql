/*
  # Add PostGIS support for event locations
  
  1. Changes
    - Enable PostGIS extension
    - Add geometry column to events table
    - Create spatial index
    - Add helper functions for location handling
    - Update existing events with geometry data
  
  2. New Functions
    - update_event_location: Automatically updates geometry when lat/lng change
    - get_event_location_text: Formats location for display
*/
