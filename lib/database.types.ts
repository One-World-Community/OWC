...
export type Database = {
  public: {
    Tables: {
      ...
      rss_feeds: {
        Row: {
          ...
          id: string
          is_location_aware: boolean | null
        ...
        Relationships: [
          {
            ...
            columns: ["feed_id"]
            isOneToOne: false
            referencedRelation: "location_aware_feeds"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "user_feeds_feed_id_fkey"
    ...
    Functions: {
      ...
      vault_insert: {
        Args: { secret: string; secret_name?: string; description?: string }
        Returns: {
          id: string
          name: string
        }[]
    ...
    Enums: {
      feed_status: "active" | "error" | "inactive"
    }
    CompositeTypes: {
      geometry_dump: {
        path: number[] | null
